...
from braindecode.models import EEGNeX, EEGConformer, Labram
import torch
...
class Submission:
    ...
    def get_model_challenge_1(self):
        ...
        model_challenge1.load_state_dict(torch.load(resolve_path("Labram_10_29.pt"), map_location=self.device))
