...
class Submission:
    ...
    def get_model_challenge_1(self):
        ...
        model_challenge1.load_state_dict(torch.load(resolve_path("weights_challenge_1_10_28.pt"), map_location=self.device))
    ...
    def get_model_challenge_2(self):
        ...
        model_challenge2.load_state_dict(torch.load(resolve_path("model_weights_challenge_2.pt"), map_location=self.device))
